...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* ---- Mobile Bottom Nav ---- */}
      <nav className="lg:hidden fixed bottom-0 left-0 w-full bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 shadow-lg flex justify-around items-center py-3 z-50">
        <Link
          to="/"
          onClick={() => setActiveTab("/")}
          className={`flex flex-col items-center ${
            activeTab === "/" ? "text-blue-400" : "text-gray-300"
          }`}
        >
        ...
        <Link
          ...
          onClick={() => setActiveTab("/create")}
          className={`flex flex-col items-center ${
            activeTab === "/create" ? "text-green-400" : "text-gray-300"
          }`}
        >
