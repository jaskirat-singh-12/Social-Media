...
export default function Home() {
  ...
  useEffect(() => {
    fetch(`https://social-media-3wo8.onrender.com/api/post`, { credentials: "include" })
      .then((res) => res.json())
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
      <div className="flex justify-center px-2 sm:px-4 lg:px-6 pt-4 sm:pt-6 lg:pt-8">
        <div className="w-full max-w-md sm:max-w-lg lg:max-w-xl xl:max-w-2xl">
          {posts.length > 0 ? (
            posts.map((post, index) => (
              ...
              >
                {/* Top user info */}
                <div className="flex items-center justify-between px-3 sm:px-4 lg:px-6 py-3 sm:py-4 border-b border-gray-50">
                ...
                <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      ...
                      className="text-gray-500 hover:text-red-500 transition-all duration-300 transform hover:scale-110 p-2 rounded-full hover:bg-red-50"
                    >
                  ...
                  <div className="mb-2">
                    <p className="text-xs sm:text-sm font-semibold text-gray-900">
                      {Math.floor(Math.random() * 150) + 12 + (likedPosts.has(post._id) ? 1 : 0)} likes
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <button className="text-xs sm:text-sm text-gray-500 hover:text-gray-700 mt-2 transition-colors">
            ...
            <div className="flex flex-col items-center justify-center py-16 sm:py-20 lg:py-24">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">No posts found</h3>
              <p className="text-sm sm:text-base text-gray-500 text-center max-w-sm px-4">
                Your feed is empty. Start following people or create your first post to get started!
              </p>
            </div>
          )}
        </div>
